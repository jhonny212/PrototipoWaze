        ...
        open.setOnAction(e -> {
            ...
            try {
                ...
                if (file.crearArregrlo()) {
                    ...
                    controlDecamino ctrl = new controlDecamino();
...
//t.insertarDato(new ruta(null, null, -17, 0, 0, 0));
    ...
    private void abrirReportes(int inicio, int fin) {
        reportes report = new reportes(inicio, fin, this.file.getNodosGrafo().size(), this.file.getNodosGrafo());
        Stage stage = new Stage();
        stage.setTitle("Reportes");
        stage.setScene(new Scene(report.getPanel(), 500, 500));
